...
const elements = {
    ...
    savedDates: document.getElementById('savedDates')
};
...
function showNotification(message) {
    ...
    showPopup(elements.notificationPopup);
}
...
function setupEventListeners() {
    ...
    document.getElementById('closeNotification').addEventListener('click', () => {
        hidePopup(elements.notificationPopup);
    });
    ...
    elements.eventPopup.addEventListener('click', (e) => {
        if (e.target === elements.eventPopup) {
            hidePopup(elements.eventPopup);
        }
    });
    
    elements.notificationPopup.addEventListener('click', (e) => {
        if (e.target === elements.notificationPopup) {
            hidePopup(elements.notificationPopup);
        }
    });
